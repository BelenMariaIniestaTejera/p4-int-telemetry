...
// Configure INT transit node parameters.
// switch_id identifies the current INT node.
// l3_mtu is reserved for MTU-related processing.
        ...
        // Table used to configure the switch as an INT transit node.
        ...
        action int_set_header_3() {
            ...
            hdr.int_q_occupancy.q_id = 0; // Queue identifier is not available in v1model
            #ifdef BMV2
		...
		action int_set_pkt_len() {
    		hdr.int_pkt_len.setValid();
    		hdr.int_pkt_len.pkt_len = (bit<32>)standard_metadata.packet_length;
    		meta.int_metadata.int_hdr_word_len = meta.int_metadata.int_hdr_word_len + 1;
    		meta.int_metadata.insert_byte_cnt = meta.int_metadata.insert_byte_cnt + 4;
		}
